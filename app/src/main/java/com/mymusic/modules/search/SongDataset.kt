...
fun searchSongDataset(query: String) :List<String>{
    val list = mutableListOf<String>()
    for (s in SONG_DATASET){
        if (s.contains(other = query, ignoreCase = true)){
            list.add(s)
        }
        if (list.size > 10)
            break
...
val SONG_DATASET = listOf(
    ...
    "Beech Beech Mein",
    "Aakhon Aakhon",
    "Kabhi Alvida Naa Kehna Title Track",
    "All Izz Well",
    "Chandralekha",
    "Mitwa",
    "Baat Ban Jaaye",
    ...
    "Shaam Shaandaar",
    "Banjaara",
    "Akkha India Janta Hai",
    "Tharki Chokro",
    "Phir Se",
    "Gale Lag Ja",
    "Aadat (Juda Hoke Bhi)",
    "Jane Kaise Kab Kahan Iqrar Ho Gaya",
    "Agar Tum Mil Jao",
    "Kaara Fankaara",
    "Chokra Jawaan",
    ...
    "Raat Ka Nasha",
    "Zara Zara Touch Me",
    "Wada Karo Nahi Chodoge",
    "Sajde",
    "Khair Mangda",
    "Tere Naal Ishqa",
    "Na Na Na Re",
    "Tum Aa Gaye Ho Noor Aa Gaya Hai",
    "Mujeh Naulakha Mangade",
    "Ainvayi Ainvayi",
    "Awaaz Deke",
    "Tum Tak",
    "Chitta Ve",
    ...
    "Tujhe Dekha To",
    "Watan Wallon Watan Na",
    "Zara Si Dosti",
    "Pani Da Rang",
    "De De Jagah",
    "Tum Itna Jo Muskura Rahe Ho",
    "Ham The Jinke Sahare",
    "Titli",
    "Laung Da Lashkara",
    "Maa Ka Phone",
    "Zindagi Ka Safar",
    ...
    "Saajna",
    "Tere Ho Ke Rahenge",
    "Sai Baba Bolo (Album Version)",
    "Khudaya Ve Ishq Hai Kaisa",
    "Pardesi Pardesi",
    "Gulabi",
    "Dus Bahane",
    "Main Agar Kahoon",
    ...
    "Dekha Tujhe Toh",
    "Engine Ki Seeti",
    "Yeh Jawaani Hai Deewani (Mashup)",
    "Main Heroine Hoon",
    "Punjabi Mast",
    "Mere Hathon Mein Nau Nau",
    "Heer",
    "Mere Bina",
    "Ishq Chupta Nahi Chupane Se",
    "Ishq Chupta Nahi",
    "Tu Jahaan",
    "Girls Like To Swing",
    "Tu Kamaal Di Kudi",
    ...
    "Dekho Nashe Mein",
    "Mein Sharabi",
    "Ho Sarkay Leo Khattiya Jada Lage",
    ...
    "Kise Dhoondta Hai Pagal Sapare",
    ...
    "Aye Meri Zindagi – Male Version",
    "Jiya Lage Na",
    "Paas Woh Aane Lage",
    "Jaane Tere Shehar Ka",
    "Pee Paa Pee Paa",
    "Ada",
    "Chupke Chupke Ghoor Na Mujhko",
    "Pag Ghungaru Bandh",
    ...
    "Tandoori Nights",
    "Kya Raaz Hai",
    "Tum Toh Dhokabaaz Ho",
    "Lucky Boy",
    "Aye Manya",
    "Ladki Hai Ya Shola",
    "Yeh Mera Dil Yaar Ka Diwana",
    "Babuji Zara Dheere Chalo",
    "Aankhon Aankhon (Remix)",
    "Ek Duje Ke Vaaste",
    "Hey Ya I See You Walking",
    "More Haji Piya",
    ...
    "Kabhi Main Kahon Kabhi Tu Kahe",
    "Mangalayam",
    "Naina Mile",
    "Phir Wahi",
    ...
    "Main Naa Bhoolunga I",
    "Allah Hafiz",
    "20-20",
    "Des Mere Des",
    "Besharmi Ki Height (Remix)",
    ...
    "Bismil",
    "Jadugar Ka Jadoo",
    "Pyar Chahiye Mujhe Jine Ke Liye",
    "Assalaam Vaalekum",
    ...
    "Dil Samander",
    "Seena Pada",
    "Bahut Pyar Karte Hai (Male Version)",
    "Baari Barsi",
    ...
    "Na Jaa",
    "Mai Ri Mai",
    "Jiske Liye Sabko Chhoda",
    "Thori Se Jo Peeli Hai",
    "Desi Beat",
    "Lamha Lamha",
    "Kaisi Yeh Judai Hain",
    "Chaudhvin Ka Chand",
    "Jeth Ki Dophar Mein",
    "Jingle Jingle",
    "Gadbad Ho Gayee",
    ...
    "Jeeye To Jeeye Kaise (Duet Version)",
    "O Mehbooba",
    "Alcholic (Remix)",
    "Pehli Baar Mile Hain",
    "Main Hoon No 1 Gawaiya",
    "Tu",
    "Rab Ka Shukrana",
    "Ek But Banaoonga",
    "Muskurane (Unplugged)",
    ...
    "Sunny Sunny (Remix)",
    "In Panchion Ko Dekh Kar",
    "Lovely (Remix)",
    "Mere Mehboob Tujhe",
    "Naam Mera Premkali",
    "Humka Peeni Hai Peeni",
    "Humka Peeni Hai",
    "Bye Bye Miss Good Night",
    "Bana Ke Kyon Bigada Re",
    "Mausam Hai Bada Qatil",
    "Ram Narayan Baaja Bajaata",
    "Ek Duje Ke Vaaste",
    "Yeh Joker",
    ...
    "Do Dilon Ke",
    "Mere Angne Mein",
    "Raat Ko Neend Aati Nahi",
    "Saiyyan",
    "Mere Ghulam Tera",
    "Sehra",
    "Sharma Ke Ye Kyon Sab Pardanashi",
    "Pyar Ko Ho Jane Do",
    "Dil Darbadar",
    "Rind Posh Maal",
    ...
    "No. 1 Punjabi",
    "Jeeley Yeh Lamhe",
    "Aaur Main Khush Hoon",
    "Alvida",
    "Bachalo Bachalo",
    "Tujhpe Fida",
    "Kya Mil Gaya Hay Kya Kho Gaya",
    "Chittiyaan Kalaiyaan (Remix)",
    "Bumbro Bumbro",
    "Khul Kabhi Toh",
    "Pankhon Ko",
    "Miliyo Re",
    ...
    "Catch Me If U Can",
    "Kabhi Tu Chalia Lagta Hai",
    "Lakhon Tare Aasman Per",
    "Farrata",
    "Ye Mera Dil Pagal Hai",
    "Tune Maari Entriyaan (Remix)",
    "Dushman Dil Ka Jo",
    ...
    "Tu Mujhe Suna",
    "Kabhi Khushboo",
    "Matari Kotmari Tumba",
    "Haule Haule (Remix)",
    "Horn OK Please",
    "Raah Mein Un Se",
    "Nazar Bachakar Chale Gaye Woh",
    "Gudiya Rani",
    ...
    "Ye Awaaz Hai",
    "Jawani Ki Rail Kahin Choot Na Jaye",
    "Kuch To Baaki Hai",
    ...
    "Jiyara Jiyara",
    "All The Best",
    "Mallo Malli (Lehmber Hussainpuri)",
    "Freak Out",
    ...
    "Teri Tamanna",
    "Lage Na Mora Jiya",
    "Jane Kya Dhoondti Rahti Hai",
    "Mujhe Dekhkar Aap Ka Muskurana",
    "E – Gulbadan Phoolon Ki Mahek",
    "Chahat Se Hai Begani",
    "Action Jackson",
    "Tujhko Bhulana",
    "Chodo Kal Ki Batein",
    "Dooba Re Dooba",
    "Dillagi Main Jo Beet Jaye",
    "Tere Chehre Pe",
    "Khulla Saand",
    "Rang Se Hui",
    ...
    "Hamdam Mere",
    "Band Baaja Baaraat Mashup",
    "Teetar Ke Do Aage Teetar",
    "Shakira",
    "Shakira",
    "Jiya Le Gayo Ji Mora Sanwariya",
    "Mori Chham Chham Baje Payaliya",
    "G Pe Danda",
    "Lootnewale",
    "Anjaana Anjaani Ki Kahani",
    "Teen Patti",
    "Khuda Hafiz Anjaani Anjaana",
    "Jaane",
    "Awaara",
    ...
    "Jane Kahan Gayi",
    "Mirza Se Darre Khuda Daler Mehndi",
    "Larki Deewani Dekho",
    "Arre Yaaro Mere Pyaaro",
    "Reham Nazar Karo",
    ...
    "Baadalon Mein Chup Raha Chand",
    "Paaji Tussi Such A Pussy Cat (Remix)",
    "Dil Na Kahin Lagana",
    "Tan Rang Lo Ji Aaj Man Ranglo",
    "Gori Ghunghat Mein Mukhda",
    "Azmale Ye Formulae",
    "O Chhalia Re Chhalia",
    "Rang Deni",
    "Is Nagari Mein",
    "Kateli Kateli Nasheli Nasheli",
    ...
    "Tanki (Bhaven Version)",
    "Har Subah",
    "Khel Wohi Phir Aaj Tu Khela",
    "Chhad Zid Karna",
    "Pal Mein Mila Jahan",
    "Balam Se Milan Hoga",
    "Phool Bagiya Men Bhanware Aaye",
    "Itni Badi Mehfil",
    "Ishq Nachaya Kare",
    "Mohabbat Ke Din Ho",
    "Saaiyaan",
    ...
    "Parody",
    "Socho Ke Jheelon Ka",
    "Hum Badi Door Chale Aaye",
    "Yeh Hava Yeh Fiza",
    "Mil Gaya",
    "Jashna Hai Mohabbat Ka",
    "Jhanan Ghoongar Baje",
    "Nazar Mein Hai Chehra",
    "Sata Le Ae Jahan",
    "Nazar Mere Dil Ke Par",
    ...
    "Khudaya Khair",
    "Darbadar",
    "Pata Hi Na Chala Sad",
    "Agg Lage Aaj Kal De Fashion Nu",
    "Dar Pe Aaye Hain Tere Kasam Le",
    "Yaar De Viah",
    "Sunle Tu Dilki Sadaa",
    "Tum Ko Hum Dilbar",
    "Mohabbat Isko Kahte Hain",
    "Goodnight",
    "Dhadkanein Kehti Hai",
